    ...
    <header>
        <div class="nav">
              <ul>
              	...
              	<li style="text-align: center"><a href="${pageContext.request.contextPath}/dashBoard/employe">Employe</a></li>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="${pageContext.request.contextPath}/dashBoard/employe/equipe/create" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Create Equipe</span></a>
                ...
                <tbody>
					...
					<c:forEach items="<%=equipes %>" var="equipe">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/dashBoard/employe/editEquipe?code_equipe=${equipe.getId()}" class="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
							</td>

							<td>
								<a href="${pageContext.request.contextPath}/dashBoard/employe/deleteEquipe?code_equipe=${equipe.getId()}" class="delete" ><i class="material-icons" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
					</c:forEach>
