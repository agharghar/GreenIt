        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="${pageContext.request.contextPath}/dashBoard/projet/createProjet" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Ajouter Projet</span></a>
					</div>
                </div>
            </div>
                ...
                <tbody>
					...
					<c:forEach items="<%= projects %>" var="project" >
					  	<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/dashBoard/projet/projetEdit?code_pro=${project.getCode_pro()}" class="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
							</td>

							<td>
								<a href="${pageContext.request.contextPath}/dashBoard/projet/projetDelete?code_pro=${project.getCode_pro()}" class="delete" ><i class="material-icons" title="Delete">&#xE872;</i></a>
							</td>
					    </tr>
